...
t1=threading.Thread(target=squares, args=(lst,) )#Here t1 is  Called Sub Thread Object whose default name is thread-1
#Create a Sub Thread for executing cubes()
t2=threading.Thread(target=cubes,args=(lst,) )#Here t2 is  Called Sub Thread Object whose default name is thread-2
